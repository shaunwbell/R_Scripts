...
b2w <- c("#FFFFFF", "#BDC9E1", "#74A9CF", "#2B8CBE", "#045A8D")   #white to blue
...
#vals <- runif(ndays, -100, 100)
  ...
  #stock data:
  casts <- "MSFT"
  start.date <- "2011-00-01"
  end.date <- Sys.Date()
      
  casts.data <- read.csv('/Users/bell/scratch/castcount_summary/2010_2015_castsum.csv', as.is=TRUE)
  
  # Plot as calendar heatmap
  calendarHeat(casts.data$date, casts.data$castnum, varname="Casts Per Day")
}