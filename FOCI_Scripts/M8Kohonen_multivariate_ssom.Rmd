...
```
Using NCEP Reanalysis II mean-daily 2m air temperature on four grid points (p1-181.875,65.712 p2-193.125,65.712 p3-181.875,58.0939 p4-193.125,58.0939)
...
ice_data = data.matrix(read.csv('/Volumes/WDC_internal/Users/bell/in_and_outbox/2017/stabeno/Ice_kohonen/1979-2016_4pt_noland_DF.asc')) / 100.

temp_noscale = data.matrix(read.csv('/Volumes/WDC_internal/Users/bell/in_and_outbox/2017/stabeno/Ice_kohonen/1979-2017_NCEP_2mtemp_p8d.csv'))
temp_data = scale(temp_noscale,center=TRUE,scale=TRUE)

mslp_noscale = data.matrix(read.csv('/Volumes/WDC_internal/Users/bell/in_and_outbox/2017/stabeno/Ice_kohonen/1979-2017_NCEPmslp_p8d.csv'))
mslp_data = scale(mslp_data,center=TRUE,scale=TRUE)
