...
Stagger MSLP and Temperature so that it leads ICE by one 8day period (for 12day add 4 additional days to start of period)
```{r}
library(kohonen)

ice_data = data.matrix(read.csv('/Users/bell/in_and_outbox/2017/stabeno/Ice_kohonen/1979-2016_4pt_noland_DF.asc')) / 100.

temp_noscale = data.matrix(read.csv('/Users/bell/in_and_outbox/2017/stabeno/Ice_kohonen/1979-2017_NCEP_2mtemp_p8d.csv'))
temp_data = scale(temp_noscale,center=TRUE,scale=TRUE)

mslp_noscale = data.matrix(read.csv('/Users/bell/in_and_outbox/2017/stabeno/Ice_kohonen/1979-2017_NCEPmslp_p12d.csv'))
